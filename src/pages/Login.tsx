      ...
      <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md border border-slate-200 relative z-10">
        ...
        {!isVerified ? (
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="PIN"
                  className="w-full pl-10 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition font-mono tracking-widest text-center text-lg"
                  autoFocus
                />
              </div>
            </div>
          ...
          <form onSubmit={handleLogin} className="space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-blue-600 text-white py-3 rounded-xl font-bold hover:bg-blue-700 transition disabled:opacity-70 mt-4"
            >
        ...
        <div className="mt-8 pt-6 border-t border-slate-100 text-center">
          <p className="text-xs text-slate-400">
            IP Address & Waktu Akses dicatat oleh sistem keamanan.
          </p>
        </div>
      </div>
    </div>
